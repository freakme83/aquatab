...
export class Fish {
  ...
  toJSON() {
    return {
      ...
      deadAtSec: this.deadAtSec ?? null,
      skeletonAtSec: this.skeletonAtSec ?? null,
  ...
  static fromJSON(bounds, data) {
    const fish = new Fish(bounds, {
      id: data.id,
      name: data.name,
      spawnTimeSec: data.spawnTimeSec,
      size: data.size,
    ...
    fish.facing = data.facing ?? fish.facing;
    fish.desiredAngle = data.desiredAngle ?? fish.desiredAngle;
    fish.currentSpeed = data.currentSpeed ?? fish.currentSpeed;
    fish.cruisePhase = data.cruisePhase ?? fish.cruisePhase;
    fish.cruiseRate = data.cruiseRate ?? fish.cruiseRate;

    fish.hunger01 = data.hunger01 ?? fish.hunger01;
    fish.hungerState = data.hungerState ?? fish.hungerState;
    fish.energy01 = data.energy01 ?? fish.energy01;
    fish.wellbeing01 = data.wellbeing01 ?? fish.wellbeing01;
    fish.sex = data.sex ?? fish.sex;

    fish.lifeState = data.lifeState ?? fish.lifeState;
    fish.deadAtSec = data.deadAtSec ?? fish.deadAtSec;
    fish.skeletonAtSec = data.skeletonAtSec ?? fish.skeletonAtSec;

    fish.behavior = data.behavior ?? fish.behavior;
    fish.target = data.target ?? fish.target;
